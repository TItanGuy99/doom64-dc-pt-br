...
#define MK_TXT01t1	"DEMONIO MATERNO: HAHAHAHA!"
#define MK_TXT02t1	"DEMONIO MATERNO: VOCE NAO DEVERIA\nTER FEITO ISSO."
...
#define MK_TXT09t1	"DEMONIO MATERNO: VOCE PREGUICOSO @&$#!"
#define MK_TXT10t1	"DEMONIO MATERNO: JA SE SATISFEZ?"
